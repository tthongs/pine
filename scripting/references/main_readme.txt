...
find -type f -name "f1" -delete

-exec cmd {}\;


find -type f -name "f1" -exec cat {} \;
this is f1
this is f1 inside d1

find -mindepth 2 -type f -name "f1" -exec cat {} \;
this is f1 inside d1

rm -i file : ask user before delete

find -type f -name "f1" -exec rm -i {} \;
rm: remove regular empty file './f1'? y
rm: remove regular file './d1/f1'? n
...
pine@pine:~/PINE/2026/UNIX_BASH/BASH$ find -type f -name "*sh"
./find.sh
./f1.sh
...
readlink -f f1
/home/pine/PINE/2026/UNIX_BASH/BASH/f1

how to get parent dir path of f1
...
/home/pine/PINE/2026/UNIX_BASH/BASH/f1
dirname $p
/home/pine/PINE/2026/UNIX_BASH/BASH
pp=$(dirname $p)
echo $pp
/home/pine/PINE/2026/UNIX_BASH/BASH
...
mtime:						
	modification time
		file size : effects both mtime / ctime

ctime:
	change time
		permissions : effects only ctime
...
gtar : data compression

gzip


echo $$  :      PID of bash shell
echo $!  : 	PID of latest BG job
kill -9 $!
...
-s : if file exists and non-empty
...
test -r file && test -w file && test -x file
...
(4)
display error if var is not passed
${var:?ERR}
...
0
unset a
echo ${a:?"var not defined"}
bash: a: var not defined
echo $?
1
...
(5)
remove pattern from string/var val
${var%patt}
remove smallest matched pattern from right of the var val
${var%%patt}
removed longest matched patt from right of the var val
...
${var#patt}
remove smallest matched patt from left side
${var##patt}
remove longest matched patt from left
...
echo $p
/home/pine/PINE/2026/UNIX_BASH/BASH/sedfile_grepfile.tar.gz
echo ${p##*/}
sedfile_grepfile.tar.gz
...
patt: doesnt support regex
	it supports unix patt style patt
...
x="use linux,linux or die"
echo ${x/linux/unix}
use unix,linux or die
echo ${x//linux/unix}
use unix,unix or die
echo $x
use linux,linux or die
...
test cmd : sh shell (bourne shell)
...
bash:
[[ ]]
	use all switch supported by "help test" plus regex =~

arithmatic expansion
(( ))
	use all switch suppooted by "help let"

do not use : test cmd or [ ]
...
declare -a arr1
arr1=(d e f)
declare -a arr2=(i j k)
unset arr2



index array and associative arrays
...
u=`whoami`  (sh method not recommended in bash)
...
cat 0< file
stream : stdin
discriptor number is 0 for stdin stream

diff <(egrep 'pine' f1) <(egrep 'pine' f2)
diff <(ls D1) <(ls D2)


eval in bash

pine@pine:~/PINE/2026/UNIX_BASH/BASH$ a=10
pine@pine:~/PINE/2026/UNIX_BASH/BASH$ b=a
pine@pine:~/PINE/2026/UNIX_BASH/BASH$ eval echo \$$b
10


eval echo $s
/home/pine/PINE/2026/UNIX_BASH/BASH
pine@pine:~/PINE/2026/UNIX_BASH/BASH$ p=$(eval echo $s)
pine@pine:~/PINE/2026/UNIX_BASH/BASH$ echo $p
/home/pine/PINE/2026/UNIX_BASH/BASH
