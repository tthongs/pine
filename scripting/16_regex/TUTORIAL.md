...
- **Literal Chars**: Match exactly what is typed.
- **Character Sets `[]`**: Match any character inside the brackets.
- **Word Boundaries**: Use `/^[aA]$/p` (sed) to match lines containing *exactly* one character 'a' or 'A'.
